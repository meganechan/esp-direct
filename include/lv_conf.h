 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 256 when LV_COLOR_DEPTH == 16*/
 ...
 *If LV_USE_ASSERT_NULL is enabled then objects created with lv_mem_alloc() are checked if not NULL.*/
